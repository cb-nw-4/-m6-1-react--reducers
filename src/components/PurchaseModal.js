...
const PurchaseModal = ()=> {
    const {
        ...
        actions: { CancelBookingProcess, PurchaseTicketRequest, PurchaseTicketFailure, PurchaseTicketSuccess }
    ...
    const handleClick = (ev)=>{
        ...
        const postObject = {seatId:seatId,creditCard:creditCard,expiration:expiration};
    ...
    return (
        <Dialog open={selectedSeatId !== null} >
            ...
            <ModalBox>
                ...
                <Info>You're purchasing <strong>1</strong> ticket for the price of ${price}</Info>
                <Table>
                    <Row>
